...
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
    console.log('NO creds found in system to login.\nGenerating creds via session id.')
    if(cc.length<30){
    const axios = require('axios');
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.');
        console.log('Please provide correct Mongodb URI.');
        console.log(e);
	}
    }
    main()
    ...
    async function syncdb() {
        ...
        const Void = VoidConnect({
            ...
            browser: ['Sasank Reddy', 'safari', '1.0.0'],
...
`,
                ...
                ///////////////////////////////////////////////////////////////////////
//                                        CHATGPT INTEGRATION
//                                via api key with brainshop and mongodb
                ///////////////////////////////////////////////////////////////////////
